...
public class PrimerBarcode {
	...
	public static void main(String[] args) {
	       ...
	       try {
	           ...
	           code128_2.setCode("1");
	           Image image128_2 = code128_2.createImageWithBarcode(cb, null, null);
	           String stCode128 = code128_2.getHumanReadableUCCEAN("1");
	           System.out.println(stCode128);
	           ////
	           ...
	           ///
	           table.addCell("CODE 128 carton");
	           table.addCell(new Phrase(new Chunk(image128_2, 0, 0)));
	           ///
